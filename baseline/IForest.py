...
# 调试 改变FPR_list参数 仅针对Graph  与异常点比例有关
FPR_list = np.arange(0.01, 0.51, 0.01)  # 扩大范围，从1%到50%
...
def train_process(dataset, subset):
    ...
    if best_model is None:
        raise ValueError("No valid model found during training. Check the training data and F1 scores.")
